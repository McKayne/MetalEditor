...
class Capsule: SceneObject {
    ...
    private func appendCylinder() {
        ...
        for vertAngle in stride(from: 0.0, to: segmentAngle * Float(segments / 2), by: segmentAngle) {
            for angle in stride(from: 0.0, to: segmentAngle * Float(segments), by: segmentAngle) {
                position.append(customFloat4(x: x + sphereX(radius: radius, horizAngle: angle + segmentAngle, vertAngle: vertAngle), y: height + y + sphereY(radius: radius, horizAngle: angle + segmentAngle, vertAngle: vertAngle), z: z + sphereZ(radius: radius, horizAngle: angle + segmentAngle, vertAngle: vertAngle), w: 1.0))
                position.append(customFloat4(x: x + sphereX(radius: radius, horizAngle: angle, vertAngle: vertAngle), y: height + y + sphereY(radius: radius, horizAngle: angle, vertAngle: vertAngle), z: z + sphereZ(radius: radius, horizAngle: angle, vertAngle: vertAngle), w: 1.0))
                position.append(customFloat4(x: x + sphereX(radius: radius, horizAngle: angle + segmentAngle, vertAngle: vertAngle + segmentAngle), y: height + y + sphereY(radius: radius, horizAngle: angle + segmentAngle, vertAngle: vertAngle + segmentAngle), z: z + sphereZ(radius: radius, horizAngle: angle + segmentAngle, vertAngle: vertAngle + segmentAngle), w: 1.0))
                
                position.append(customFloat4(x: x + sphereX(radius: radius, horizAngle: angle, vertAngle: vertAngle + segmentAngle), y: height + y + sphereY(radius: radius, horizAngle: angle, vertAngle: vertAngle + segmentAngle), z: z + sphereZ(radius: radius, horizAngle: angle, vertAngle: vertAngle + segmentAngle), w: 1.0))
                position.append(customFloat4(x: x + sphereX(radius: radius, horizAngle: angle + segmentAngle, vertAngle: vertAngle + segmentAngle), y: height + y + sphereY(radius: radius, horizAngle: angle + segmentAngle, vertAngle: vertAngle + segmentAngle), z: z + sphereZ(radius: radius, horizAngle: angle + segmentAngle, vertAngle: vertAngle + segmentAngle), w: 1.0))
                position.append(customFloat4(x: x + sphereX(radius: radius, horizAngle: angle, vertAngle: vertAngle), y: height + y + sphereY(radius: radius, horizAngle: angle, vertAngle: vertAngle), z: z + sphereZ(radius: radius, horizAngle: angle, vertAngle: vertAngle), w: 1.0))
            }
        }
