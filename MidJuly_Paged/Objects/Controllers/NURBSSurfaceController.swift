...
class NURBSSurfaceController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "NURBS Surface"
    }
    
    func popToScene(sender: UIBarButtonItem) {
        
        let surface = NURBSSurface(x: -2, y: 0, z: 2, width: 4, depth: 4, rgb: (255, 0, 255))
