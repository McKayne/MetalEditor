...
class StairsController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Stairs"
    }
    
    func popToScene(sender: UIBarButtonItem) {
        
        let stairs = Stairs(x: -0.25, y: 0, z: -0.25, width: 1, height: 1, depth: 1, steps: 5, rgb: (255, 0, 255)) // Ladder(x: -0.25, y: 0, z: -0.25, width: 1, height: 1, depth: 1, rgb: (255, 0, 255))
        
        RootViewController.scenes[RootViewController.currentScene].appendObjectWithoutUpdate(object: stairs)
