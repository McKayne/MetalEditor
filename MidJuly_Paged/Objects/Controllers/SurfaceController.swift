...
class SurfaceController: UIViewController {
    ...
    func popToScene(sender: UIBarButtonItem) {
        ...
        //let surface = Surface(x: -2, y: 0, z: 2, width: 4, depth: 4, rgb: (255, 0, 255))
        let surface = Surface(x: -2, y: 0, z: 2, width: 8, depth: 5, rgb: (255, 0, 255))
