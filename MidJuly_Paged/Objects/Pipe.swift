...
class Pipe: SceneObject {
    ...
    private func appendCylinder() {
        ...
        for angle in stride(from: 0.0, to: segmentAngle * Float(segments), by: segmentAngle) {
            ...
            position.append(customFloat4(x: x + cos(angle * 3.14 / 180.0) * innerRadius, y: y, z: z + sin(angle * 3.14 / 180.0) * innerRadius, w: 1.0))
            position.append(customFloat4(x: x + cos((angle + segmentAngle) * 3.14 / 180.0) * innerRadius, y: y, z: z + sin((angle + segmentAngle) * 3.14 / 180.0) * innerRadius, w: 1.0))
            position.append(customFloat4(x: x + cos(angle * 3.14 / 180.0) * innerRadius, y: y + height, z: z + sin(angle * 3.14 / 180.0) * innerRadius, w: 1.0))
            
            position.append(customFloat4(x: x + cos((angle + segmentAngle) * 3.14 / 180.0) * innerRadius, y: y + height, z: z + sin((angle + segmentAngle) * 3.14 / 180.0) * innerRadius, w: 1.0))
            position.append(customFloat4(x: x + cos(angle * 3.14 / 180.0) * innerRadius, y: y + height, z: z + sin(angle * 3.14 / 180.0) * innerRadius, w: 1.0))
