...
class RotationController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIPickerViewDelegate, UIPickerViewDataSource {
            ...
            if let xPosition = Float(xPositionText), let yPosition = Float(yPositionText), let zPosition = Float(zPositionText) {
                ...
                for i in 0..<RootViewController.scenes[RootViewController.currentScene].objects.count {
                    if RootViewController.scenes[RootViewController.currentScene].objects[i].isSelected {
                        ...
                        RootViewController.scenes[RootViewController.currentScene].updateHistory(id: i, msg: "Rotate object", type: .rotation)
                        ...
                        RootViewController.scenes[RootViewController.currentScene].objects[i].rotate(xAngle: xPosition, yAngle: yPosition, zAngle: zPosition)
                        break
                    }
                }
