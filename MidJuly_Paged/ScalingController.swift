//
//  ScalingController.swift
//  MidJuly_Paged
//
//  Created by для интернета on 15.03.19.
...
class ScalingController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        xPositionText.text = "1.0"
        yPositionText.text = "1.0"
        zPositionText.text = "1.0"
            ...
            if let xPosition = Float(xPositionText), let yPosition = Float(yPositionText), let zPosition = Float(zPositionText) {
                ...
                for i in 0..<RootViewController.scenes[RootViewController.currentScene].objects.count {
                    if RootViewController.scenes[RootViewController.currentScene].objects[i].isSelected {
                        ...
                        RootViewController.scenes[RootViewController.currentScene].updateHistory(id: i, msg: "Scale object", type: .scaling)
                        ...
                        RootViewController.scenes[RootViewController.currentScene].objects[i].scaleBy(widthMultiplier: xPosition, heightMultiplier: yPosition, depthMultiplier: zPosition)
                        break
                    }
                }
